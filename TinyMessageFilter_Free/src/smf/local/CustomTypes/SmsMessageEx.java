...
public class SmsMessageEx {
    ...
    public boolean isInBlackList() {
        ...
        if (CacheHelper.contains(black, rawSender))
            return true;
    ...
    public boolean isInMuteList() {
        ...
        if (CacheHelper.contains(mute, rawSender))
            return true;
    ...
    public boolean isInFavorities() {
        return CacheHelper.getFavorities().contains(rawSender);
    }
    ...
    public void showNotification(Integer icon, Intent myIntent) {
        ...
        Integer notificationId = (icon == R.drawable.question) ? SPAM_NOTIFICATION_ID : NOTIFICATION_ID;
        notificationManager.notify(notificationId, notification);
        DbHelper.addTrace("Notified.");
    }

    private int getMessagesCount(int iconId) {
        return (iconId == R.drawable.question)
