...
public class RuleModel implements Serializable, IComparableEx, IQueryableContact {
    private Integer id;
    private Boolean blockIt = false;
    private Boolean rejectCallsFromIt = false;
    private Boolean loveIt = false;
    private Boolean muteIt = false;
    private Boolean isContact = false;
    private String codePattern;
    private String bodyPattern;
    private Integer planeId = 0;
    private String name;
    private int order = 0;
    ...
    public RuleModel(Integer id, int blockIt, int ignoreIt, int loveIt, int muteIt, int isContact, String codePattern, String bodyPattern, int planeId, String name, int order) {
        ...
        this.rejectCallsFromIt = ignoreIt == 1;
...
*/
    ...
    public Boolean getRejectCallsFromIt() {
        return rejectCallsFromIt;
    }

    public void setRejectCallsFromIt(Boolean rejectCallsFromIt) {
        this.rejectCallsFromIt = rejectCallsFromIt;
    }
