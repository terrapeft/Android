...
public class Statistics extends Activity
{
    public void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            UpdateStatistics();
            //RuleModelCollectionTest t = new RuleModelCollectionTest();
            //t.testMatch();
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            switch (v.getId())
            {
                ...
                case R.id.contactsButton:
                    Intent cIntent = new Intent(this, RuleList.class);
    ...
    private void UpdateStatistics()
    {
        ...
        final TextView callsLbl = (TextView) findViewById(R.id.callsCount);
        int callsCount = DbHelper.getRejectedCallsCount();
        callsLbl.setText(String.valueOf(callsCount));
