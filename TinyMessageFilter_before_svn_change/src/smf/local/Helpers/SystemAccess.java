...
public class SystemAccess {
    ...
    public static void startPatternDialog(final Activity activity, int resource, final FileModel em) {
        ...
        ad.setPositiveButton("Add", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                FileModel fm = new FileModel(-1, blockIt, ignoreIt, 0, muteIt, 0, codePattern, bodyPattern, R.drawable.paper_plane_24, name);

                if (em != null) fm.setId(em.getId());

                ((FileList) activity).endPatternDialog(fm);
            }
        });
